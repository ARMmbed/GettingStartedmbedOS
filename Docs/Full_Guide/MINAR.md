...
<span style="background-color: #F0F0F5; display:block; height:100%; padding:10px;">![Interrupt-based tasks](Images/post_callback.png)</span>

* Tasks with delays, and a single task with intervals:
<span style="background-color: #F0F0F5; display:block; height:100%; padding:10px;">![These tasks have delay or interval parameters](Images/post_callback_d_i.png)</span>
...
<span style="background-color: #F0F0F5; display:block; height:100%; padding:10px;">![Task 2 is executed only after Task 3](Images/post_callback_t_2.png)</span>
...
<span style="background-color: #F0F0F5; display:block; height:100%; padding:10px;">![Two of these tasks have a tolerance, giving MINAR some execution freedom](Images/post_callback_t.png)</span>
